...
namespace FoodOrderingSystem.Services.Implementations
{
    public class UserService : IUserService
    {
        ...
        public async Task<RegisterDto> AddModeratorUser(RegisterDto model, string imageString)
        {
            var user = _mapper.Map<User>(model);
            user.UserName = model.UserName.ToLower();
            user.IsActive = true;
            user.ImageUrl = imageString;
        ...
        public async Task<RegisterDto> AddAdminUser(RegisterDto model, string imageString)
        {
            var user = new User
            {
        ...
        public async Task<RegisterDto> UpdateUser(string id, RegisterDto model, string imageString)
        {
