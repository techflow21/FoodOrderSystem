...
namespace AspnetRun.Application.Services
{
    ...
    public class FoodService : IProductService
    {
        private readonly IProductRepository _productRepository;
        private readonly IAppLogger<FoodService> _logger;

        public FoodService(IProductRepository productRepository, IAppLogger<FoodService> logger)
        {
